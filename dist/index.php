...
if ($username) {
    ...
    $stmt = $conn->prepare("SELECT * FROM dash WHERE username = ? OR email = ? LIMIT 1");
            ...
            <li class="nav-item dropdown d-none d-lg-block user-dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                <div class="dropdown-header text-center">
                 <img class="img-xs rounded-circle" src="<?php echo $user_image; ?>" alt="Profile image">
                  <p class="mb-1 mt-3 fw-semibold"><?php echo $user_display ? $user_display : 'Guest'; ?></p>
                  <p class="fw-light text-muted mb-0"><?php echo $user_email ? $user_email : ''; ?></p>
                </div>
